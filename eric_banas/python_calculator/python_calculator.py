...
class Calculator():
    ...
    def button_press(self, value):
        ...
        entry_val = self.number_entry.get() #.get is a tk method
    ...
    def is_float(self, str_val):
        ...
        try:
            ...
            # ValueError
            float(str_val)
            return True # If there is a value you want to return use return
        except ValueError:
            return False
    ...
    def __init__(self, root):
        """Initializing Calculator attributes"""
        ...
        root.geometry("420x215") # height x width
        
        # Block resizing of Window
        root.resizable(width=False, height=False) #user shouldn't be able to change
        ...
        command = lambda : self.button_press('3')).grid(row=3, column=0 )
        ...
        command = lambda : self.button_press('1')).grid(row=3, column=2 )
